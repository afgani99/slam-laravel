                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="search" name="search" type="search" class="block w-full pl-10"
                            placeholder="Nomor tiket, CID, pelanggan, kasus…" :value="$search" />
                    </div>
                </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-16 text-center">
                                    ...
                                    <p class="text-sm text-neutral-500">Tidak ada tiket ditemukan.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                    ...
                    <form method="POST" action="{{ route('tickets.store') }}" class="p-6">
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            ...
                            <div x-data="{ search: '', open: false }" class="md:col-span-2">
                                <x-input-label for="ticket_index_cid_search" value="Pilih CID" />
                                <div class="relative mt-1">
                                    <x-text-input
                                        ...
                                        placeholder="Cari CID / Nama Pelanggan / CID IS..."
                                        class="w-full"
                                        autocomplete="off" />
                                    ...
                                    <ul x-show="open" x-cloak
                                        ...
                                        <li x-show="cidsList.filter(c =>
                                            ...
                                            class="px-4 py-2 text-sm text-neutral-500">Tidak ditemukan</li>
                                    </ul>
                                </div>
                            ...
                            {{-- Info readonly CID --}}
                            <div>
                                <x-input-label value="Nama Vendor" />
                            ...
                            {{-- Ticket ID Vendor --}}
                            <div>
                                <x-input-label for="ticket_index_vendor_ticket_number" value="Ticket ID Vendor" />
                            ...
                            {{-- Kasus --}}
                            <div>
                                <x-input-label for="ticket_index_case_type" value="Kasus" />
                                <div class="relative mt-1">
                            ...
                            <div class="md:col-span-2">
                                <x-input-label for="ticket_index_started_at" value="Waktu Mulai" />
